class Fan
  ...
  def control_method_enums
    %w(ConstantVolume VariableSpeedDrive Dampers InletVanes VariablePitchBlades TwoSpeed)
  end
  ...
  def centrifugal_type_enums
    %w(AirFoil BackwardInclined ForwardCurved)
  end

  def modeling_method_enums
    %w(StaticPressure BrakeHorsePower PowerPerUnitFlow)
  end
