class Material
  ...
  # This method been overloaded to not do anything because if you import an existing SDD XML then
  # it should not load the materials, rather, it will will read from the database to get the material layers
