class Project
  ...
  field :compliance_report_xml, type: Integer
	...
	def get_exceptional_condition_complete_building_enums
		[
			'Yes',
			'No'
		]
	...
	def get_exceptional_condition_exterior_lighting_enums
		[
			'Yes',
			'No'
		]
	...
	def get_exceptional_condition_no_cooling_system_enums
		[
			'Yes',
			'No'
		]
	...
	def get_exceptional_condition_rated_capacity_enums
		[
			'Yes',
			'No'
		]
	...
	def get_exceptional_condition_water_heater_enums
		[
			'Yes',
			'No'
		]
	...
	def get_exceptional_condition_narrative_enums
		[
			'Yes',
			'No'
		]
