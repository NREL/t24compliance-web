class ConstructAssembly
  ...
  def compatible_surface_type_enums
    %w(ExteriorWall Roof ExteriorFloor UndergroundWall UndergroundFloor InteriorWall Ceiling InteriorFloor)
  end
  ...
  def slab_insulation_orientation_enums
    %w(None 12inHorizontal 24inHorizontal 36inHorizontal 48inHorizontal 12inVertical 24inVertical 36inVertical 48inVertical FullyInsulatedSlab)
  end

  def slab_insulation_thermal_resistance_enums
    %w(R0 R5 R7_5 R10 R15 R20 R25 R30 R35 R40 R45 R50 R55)
  end
end
