cbecc.controller('ProjectCtrl', [
  '$scope', '$rootScope', '$stateParams', '$resource', '$location', 'toaster', 'Project', 'Shared', 'Enums', function ($scope, $rootScope, $stateParams, $resource, $location, toaster, Project, Shared, Enums) {
