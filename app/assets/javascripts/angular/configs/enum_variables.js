...
var project_climate_zone_enums = [
  '- select -',
  'ClimateZone1',
  'ClimateZone2',
  'ClimateZone3',
...
var project_weather_station_enums = [
  '- select -',
  'ALTURAS_725958',
  'ARCATA_725945',
  'BAKERSFIELD_723840',
...
var project_exceptional_condition_complete_building_enums = [
  'Yes',
  'No'
];

var project_exceptional_condition_exterior_lighting_enums = [
  'Yes',
  'No'
];


var project_exceptional_condition_no_cooling_system_enums = [
  'Yes',
  'No'
];

var project_exceptional_condition_rated_capacity_enums = [
  'Yes',
  'No'
];

var project_exceptional_condition_water_heater_enums = [
  'Yes',
  'No'
];

var project_exceptional_condition_narrative_enums = [
  'Yes',
  'No'
];
...
var spaces_space_function_enums = [
...
var spaces_conditioning_type_enums = [
  'DirectlyConditioned',
...
var spaces_envelope_status_enums = [
  'New',
  'Altered',
  'Existing'
];

var spaces_lighting_status_enums = [
  'New',
  'Altered',
  'Existing',
  'Future'
