cbecc.factory('Shared', ['$q', '$templateCache', '$sce', 'DSCacheFactory', 'usSpinnerService', 'uiGridConstants', function ($q, $templateCache, $sce, DSCacheFactory, usSpinnerService, uiGridConstants) {
  ...
  $templateCache.put('ui-grid/cbeccConstructionCell', '<div class="ui-grid-cell-contents"><span class="glyphicon glyphicon-edit pull-right edit" ui-grid-visible=\"col.colDef.allowConstructionEdit\" aria-hidden="true" ng-click="$parent.$parent.$parent.$parent.$parent.$parent.$parent.changeConstruction(row.entity)"></span><span>{{COL_FIELD}}</span></div>');
