class ProjectsController < ApplicationController
  ...
  private
    ...
    def check_shw
      # if exceptional_condition_water_heater is 'YES', delete SHW
      if @project.exceptional_condition_water_heater == 'Yes'
        systems = @project.fluid_systems.where(type: 'ServiceHotWater')
        systems.each do |sys|
          sys.destroy
        end
      end
