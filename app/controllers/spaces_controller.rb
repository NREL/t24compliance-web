    ...
    if clean_params.has_key?('data')
      ...
      spaces_by_story.each do |story, spaces|
        ...
        spaces.each do |space|
          ...
          lighting_systems = space.extract!('interior_lighting_system')['interior_lighting_system'] || []
          lighting_systems.each do |sys|
            if sys.has_key?('id') and !sys['id'].nil?
              ...
              # create
              @sys = InteriorLightingSystem.new(sys)
              @sys.save
            end
          ...
          @space.interior_lighting_systems = space_light_systems
          @space.save
          story_spaces << @space
        end
