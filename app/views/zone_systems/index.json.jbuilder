json.array!(@zone_systems) do |zone_system|
  ...
  json.fan zone_system.fans[0], :id, :name, :control_method, :classification, :centrifugal_type, :total_static_pressure, :flow_efficiency, :motor_bhp, :motor_hp, :motor_type, :motor_pole_count, :motor_efficiency, :motor_position
