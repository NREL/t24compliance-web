json.array!(@spaces) do |space|
  ...
  json.exterior_walls space.exterior_walls do |exterior_wall|
    ...
    json.windows exterior_wall.windows do |window|
      json.call(window, :id, :name, :area, :fenestration_construction_reference, :construction_library_id)
      json.set! :type, 'Window'
    end
  end

  json.underground_walls space.underground_walls do |underground_wall|
    json.call(underground_wall, :id, :name, :area, :height, :construct_assembly_reference, :interior_solar_absorptance, :interior_visible_absorptance, :interior_thermal_absorptance, :construction_library_id)
    json.set! :surface_type, 'Underground Wall'
  end

  json.underground_floors space.underground_floors do |underground_floor|
    json.call(underground_floor, :id, :name, :area, :perimeter_exposed, :construct_assembly_reference, :interior_solar_absorptance, :interior_visible_absorptance, :interior_thermal_absorptance, :construction_library_id)
    json.set! :surface_type, 'Underground Floor'
  end

  json.exterior_floors space.exterior_floors do |exterior_floor|
    json.call(exterior_floor, :id, :name, :area, :construct_assembly_reference, :construction_library_id)
    json.set! :surface_type, 'Exterior Floor'
  end

  json.interior_floors space.interior_floors do |interior_floor|
    json.call(interior_floor, :id, :name, :area, :construct_assembly_reference, :adjacent_space_reference, :interior_solar_absorptance, :interior_visible_absorptance, :interior_thermal_absorptance, :construction_library_id)
    json.set! :surface_type, 'Interior Floor'
  end

  json.roofs space.roofs do |roof|
    json.call(roof, :id, :name, :area, :azimuth, :construct_assembly_reference, :tilt, :interior_solar_absorptance, :interior_thermal_absorptance, :interior_visible_absorptance, :construction_library_id)
    json.set! :surface_type, 'Roof'
    json.skylights roof.skylights do |skylight|
      json.call(skylight, :id, :name, :area, :fenestration_construction_reference, :construction_library_id)
